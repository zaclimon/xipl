 ...
 *
 * Adapted for being able to seek MPEG-2 TS stream from the following commit:
 * https://github.com/amoussawi/ExoPlayer/commit/e49e3637d696c24e6001c47d499315e51a3251e3
 */
public final class SeekableTsExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() {
        ...
        public Extractor[] createExtractors() {
            return new Extractor[]{new SeekableTsExtractor()};
        }
    ...
    private TsSeekMap mSeekMap;

    public SeekableTsExtractor() {
        this(0);
    }
     ...
     */
    public SeekableTsExtractor(@Flags int defaultTsPayloadReaderFlags) {
     ...
     *                                    {@code FLAG_*} values that control the behavior of the payload readers.
     */
    public SeekableTsExtractor(@Mode int mode, @Flags int defaultTsPayloadReaderFlags) {
        this(mode, new TimestampAdjuster(0),
                new DefaultTsPayloadReaderFactory(defaultTsPayloadReaderFlags));
    }


    public SeekableTsExtractor(TsSeekMap seekMap) {
        this(0);
        mSeekMap = seekMap;
    }
     ...
     */
    public SeekableTsExtractor(@Mode int mode, TimestampAdjuster timestampAdjuster,
    ...
    public void init(ExtractorOutput output) {
        this.output = output;
        output.seekMap(mSeekMap != null ? mSeekMap : new SeekMap.Unseekable(C.TIME_UNSET));
    }
        ...
        if (adaptationFieldExists) {
            ...
            if (adaptationFieldLength > 0) {
                ...
                if (pcrFlagSet && adaptationFieldLength >= 7) {
                    ...
                    long positionMs = mSeekMap.getPcrPositionMs(pcrBytes);
                    mSeekMap.addPosition(positionMs, input.getPosition() - TS_PACKET_SIZE);
